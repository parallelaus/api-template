...
export const Environment: Environment = {
  ...
  website: {
    ...
    subscribe_success_page:
      process.env.WEBSITE_SUBSCRIBE_SUCCESS_PAGE || 'welcome',
  ...
  email: {
    ...
    mailjet: {
      api_key: process.env.EMAIL_MAILJET_API_KEY as string,
      api_secret: process.env.EMAIL_MAILJET_API_SECRET as string,
      webhook: {
        key: process.env.MAILJET_WEBHOOK_USERNAME || '7puP1Ff6AIZ4n34y',
        secret:
          process.env.MAILJET_WEBHOOK_USERNAME ||
      ...
      workflows: {
        ...
        new_user_set_password:
          process.env.EMAIL_MAILJET_WORKFLOWS_NEW_USER_SET_PASSWORD,
        ...
        first_login_reminder:
          process.env.EMAIL_MAILJET_WORKFLOWS_FIRST_LOGIN_REMINDER,
      },
      templates: {
        en: {
          ...
          payment_failed_final:
            process.env.EMAIL_MAILJET_TEMPLATES_PAYMENT_FAILED_FINAL,
          payment_succeeded:
            process.env.EMAIL_MAILJET_TEMPLATES_PAYMENT_SUCCEEDED,
          subcription_suspended:
            process.env.EMAIL_MAILJET_TEMPLATES_SUBSCRIPTION_SUSPENDED,
          subcription_reinstated:
            process.env.EMAIL_MAILJET_TEMPLATES_SUBSCRIPTION_REINSTATED,
        },
      },
    },
  },
  ...
  defaults: {
    ...
    account: {
      limits: {
        ...
        max_question_sets:
          process.env.DEFAULTS_ACCOUNT_LIMITS_MAX_QUESTION_SETS || 1,
        max_archived_question_sets:
          process.env.DEFAULTS_ACCOUNT_LIMITS_MAX_ARCHIVED_QUESTION_SETS || 0,
        max_monthly_applicants:
          process.env.DEFAULTS_ACCOUNT_LIMITS_MAX_MONTHLY_APPLICANTS || 5,
        max_monthly_minutes:
          process.env.DEFAULTS_ACCOUNT_LIMITS_MAX_MONTHLY_MINUTES || 20,
        max_monthly_ai_question_sets:
          process.env.DEFAULTS_ACCOUNT_LIMITS_MAX_MONTHLY_AI_QUESTION_SETS || 0,
      },
    },
    interview: {
      video_responses: {
        min_thinking_time:
          process.env.DEFAULTS_INTERVIEW_VIDEO_RESPONSES_MAX_THINKING_TIME ||
          30,
        max_thinking_time:
          process.env.DEFAULTS_INTERVIEW_VIDEO_RESPONSES_MAX_THINKING_TIME ||
          -1,
        max_response_time:
          process.env.DEFAULTS_INTERVIEW_VIDEO_RESPONSES_MAX_RESPONSE_TIME ||
          300,
        min_response_time:
          process.env.DEFAULTS_INTERVIEW_VIDEO_RESPONSES_MIN_RESPONSE_TIME || 0,
        max_takes:
          process.env.DEFAULTS_INTERVIEW_VIDEO_RESPONSES_MAX_TAKES || -1,
        max_sessions:
          process.env.DEFAULTS_INTERVIEW_VIDEO_RESPONSES_MAX_SESSIONS || -1,
        max_session_days:
          process.env.DEFAULTS_INTERVIEW_VIDEO_RESPONSES_MAX_SESSION_DAYS || 10,
      },
    },
  },
  ...
  stripe: {
    ...
    active_currencies:
      process.env.STRIPE_ACTIVE_CURRENCIES || 'USD,GBP,ZAR,AUD,NZD,SGD,EUR',
  },
  // files: {
  ...
  kafka: {
    ...
    topics: {
      ...
      mailjet_events:
        process.env.KAFKA_TOPICS_MAILJET_EVENTS || 'mailjet-events',
    },
  },
